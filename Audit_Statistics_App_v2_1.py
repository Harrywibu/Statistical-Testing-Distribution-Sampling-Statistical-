...
# ============== XLSX (statefix + Preset JSON) ==============
    ...
    # NOTE: do not assign to SS['pinned_cols'] because key 'pinned_cols' is widget-controlled
# Read it directly from session_state or local variable
pinned_cols = st.multiselect('📌 Cột bắt buộc (luôn nạp)', options=headers, default=SS.get('pinned_cols',[]), key='pinned_cols')
